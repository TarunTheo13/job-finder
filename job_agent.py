...
try:
    ...
    try:
        recommended_jobs = json.loads(response_content)
    except json.JSONDecodeError:
        print(f"{Colors.RED}Failed to parse JSON response. Raw response:{Colors.RESET}")
    ...
    print(f"{Colors.RED}Error processing model response: {str(e)}{Colors.RESET}")
